  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName="Home",
              ...
              div(id="headerimg", p("Crash Views")),
              
              fluidRow(style="margin-top:10px;",
                       box(width=12, collapsible = TRUE, status="info",title = list(icon("dashboard"),"Overview"),
              ...
              fluidRow(
                box(width=12,status = "warning",  title=list(tags$i(class="fa fa-grav"),"What we discovered?"),collapsible = TRUE,
                    ...
                    tabBox(
                      ...
                      column(8),
                      column(4,
                             h5("Note: More accidents happen at the beginning and the end of the year.")
                      ),
                      box(width = 12,sliderInput("year", label = "Select Year:",min = 2001, max = 2014, value = 2001, sep="", step=NULL, animate=TRUE))
      ...
      tabItem(tabName="Bike",
              h2("Widgets tab content"),
              sidebarPanel(  
                selectInput("dataset", "Choose a dataset", choices=c("Mercer County", "Ocean County")),
                selectInput("var", "Choose a field", choices=c("ID", "Crash Year"),selected="Crash Year"),
              ...
              mainPanel(
                ...
                box(width = 12,
                    h4("Summary"),
                    verbatimTextOutput("bike_summary")
                ),
                box(width = 12,
                    h4("Histograms"),
                    verbatimTextOutput("bike_bar_title"),
                    plotlyOutput("bike_bar",width = "100%", height="400px")
                ),
      ...
      tabItem(tabName="SpeedSign",
              h2("Widgets tab content"),
              box(width = 6,
                  h4("Speed Sign Data Analysis"),
                  plotlyOutput("Speed_Sign_effect", width = "auto", height = "auto")
                  )
